...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneUserGreeting = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/OneUserGreeting\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  render: function render() {
	    var usersLIs = this.props.users.map(function (user, i) {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(OneUserGreeting, { user: user, key: i }),
	        React.createElement(DeleteLine, null)
	      );
	    });
	    return React.createElement(
	      'div',
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Form, { greet: this.greet }),
	      React.createElement('hr', null),
	      React.createElement(ListOfGreetings, { users: this.state.users })
	    );
	  }
	});
